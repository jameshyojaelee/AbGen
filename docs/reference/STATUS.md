...
Date: 2025-12-22
Note: This snapshot reflects the initial baseline before subsequent refactors and fixes.
...
**Key entrypoints:**
- Console scripts in `pyproject.toml` / `setup.cfg`: `abgen-etl`, `abgen-train`, `abgen-eval`, `abgen-launch`
...
- Benchmark configs: `configs/legacy/bench.yaml`, `configs/benchmarks.yaml`, `configs/therapeutic_bench.yaml`
